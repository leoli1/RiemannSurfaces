static class Complex{
  ...
  static Complex cexp(Complex z){
    return Complex.Mul(Complex.e_to_ix(z.imag), Math.pow(e, z.real));
  }
  ...
  public double Arg2PIBranch(){
    double targ = Arg();
    return targ>=0 ? targ : targ+2*PI;
  }
  ...
  public static Complex tanh(Complex z){
    return Complex.Add(new Complex(1,0), Complex.Div(new Complex(2,0), Complex.Sub(Complex.cexp(Complex.Mul(new Complex(2,0), z)),new Complex(1,0))));
  }
}